# Contributing to Agent/API Traffic Detector

Thank you for considering contributing to **Agent/API Traffic Detector**! Your help and feedback are welcome. The following guidelines help us maintain a collaborative, productive project.

## How to Contribute

### 1. Reporting Issues
- Use the [Issue Tracker](https://github.com/aaronrusz/agent-api-traffic-detector/issues) to report bugs, suggest features, or ask questions.
...
Thank you for helping improve Agent/API Traffic Detector!